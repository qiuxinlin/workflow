...
import com.scxys.activiti.utils.GloableVariable;
...
public class WorkflowServiceImpl implements WorkflowService {
	...
	@Override
	public LeaveBill findLeaveBillByTaskId(String taskId) throws  NumberFormatException{
		//1：使用任务ID，查询任务对象Task
	...
	public void saveSubmitTask(WorkflowBean workflowBean,String userName) {
		...
		Task task = taskService.createTaskQuery()//
						...
						.singleResult();
		//获取下一个任务的办理人
		GloableVariable.currentAssignee=task.getAssignee();
		Employee currentEmploy=employeeService.findByName(GloableVariable.currentAssignee);
		if(currentEmploy.getManager()!=null){
			System.out.println("---------"+currentEmploy.getManager().getName());
			GloableVariable.nextAssigneeEm = currentEmploy.getManager();
		}
		//获取流程实例ID
		String processInstanceId = task.getProcessInstanceId();
		/**
